...
//
//#define FMDBQuickCheck(SomeBool) { if (!(SomeBool)) { DebugLog(@"Failure on line %d", __LINE__); return 123; } }
//
...
//              ) {
//            DebugLog(@"WHOA THERE BUDDY, columnNameForIndex ISN'T WORKING!");
//            return 7;
//        }
//    }
...
//        }
//        else {
//            DebugLog(@"Could not select image.");
//        }
//        
//        [rs close];
//        
//    }
//    else {
//        DebugLog(@"Can't find compass image..");
//    }
//    
//    
...
//    if (a != 5) {
//        DebugLog(@"intForQuery didn't work (a != 5)");
//    }
//    
...
//    
//    DebugLog(@"Testing the busy timeout");
//    
//    BOOL success = [db executeUpdate:@"insert into t1 values (5)"];
//    
//    if (success) {
//        DebugLog(@"Whoa- the database didn't stay locked!");
//        return 7;
//    }
//    else {
//        DebugLog(@"Hurray, our timeout worked");
//    }
//    
//    [rs close];
//    [newDb close];
...
//    if (!success) {
//        DebugLog(@"Whoa- the database shouldn't be locked!");
//        return 8;
//    }
//    else {
//        DebugLog(@"Hurray, we can insert again!");
//    }
//    
//    
//    
...
//        DebugLog(@"UH OH, can't insert a nil value for some reason...");
//    }
//    
//    
//    
...
//            DebugLog(@"OH OH, PROBLEMO!");
//            return 10;
//        }
//        else {
//            DebugLog(@"YAY, NULL VALUES");
//        }
//        
...
//            DebugLog(@"Oh crap, our update didn't work out!");
//            return 9;
//        }
//        
//        [rs2 close];
...
//        
//        if (!b) {
//            DebugLog(@"Oh crap, the nil / null inserts didn't work!");
//            return 10;
//        }
//        
//        if (a) {
//            DebugLog(@"Oh crap, the nil / null inserts didn't work (son of error message)!");
//            return 11;
//        }
//        else {
//            DebugLog(@"HURRAH FOR NSNULL (and nil)!");
//        }
//    }
//    
//    
...
//        
//        if (a) {
//            DebugLog(@"Oh crap, the null date insert didn't work!");
//            return 12;
//        }
//        
//        if (!c) {
//            DebugLog(@"Oh crap, the 0 date insert didn't work!");
//            return 12;
//        }
//        
...
//        
//        if (floor(dti) > 0.0) {
//            DebugLog(@"Date matches didn't really happen... time difference of %f", dti);
//            return 13;
//        }
//        
//        
...
//        }
//    }
//    DebugLog(@"That was version %@ of sqlite", [FMDatabase sqliteLibVersion]);
//    
//    
//    [db close];
//    
